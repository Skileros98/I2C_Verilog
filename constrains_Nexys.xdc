...
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports {segments[0]}]

set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS33} [get_ports {displays[0]}]
set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS33} [get_ports {displays[1]}]
set_property -dict {PACKAGE_PIN T9 IOSTANDARD LVCMOS33} [get_ports {displays[2]}]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports {displays[3]}]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {displays[4]}]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {displays[5]}]
set_property -dict {PACKAGE_PIN K2 IOSTANDARD LVCMOS33} [get_ports {displays[6]}]
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports {displays[7]}]
...
#create_generated_clock -name {counter_divider/Q[0]} -source [get_ports clk] -divide_by 250 [get_pins {counter_divider/counter_reg[26]/Q}]
#create_generated_clock -name {counter_segment/Q[0]} -source [get_ports clk] -divide_by 50000 [get_pins {counter_segment/counter_reg[15]/Q}]
